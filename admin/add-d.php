...
extract($_POST);
if(isset($_POST['sub'])){
    $qr=mysqli_query($con,"insert into department(name) values('$name')");

if ($qr) {
$_SESSION['bmsg']='<span style="color:green;">'."Department was added successfully....".'</span>';
} else {
    $_SESSION['bmsg']='<span style="color:red;">'."Error adding Department".'</span>';
}
