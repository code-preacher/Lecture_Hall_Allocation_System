...
if(isset($_POST['sub'])){
    $qr=mysqli_query($con,"insert into lecturer(name,email,password,department_id,date) values('$name','$email','$password','$department_id','$date')");

if ($qr) {
$_SESSION['bmsg']='<span style="color:green;">'."Lecturer was added successfully....".'</span>';
} else {
                                   ...
                                   <form action="#" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="department_id" class="form-control input-rounded" required="required">
                                                ...
                                                <?php
                                                $at=mysqli_query($con,"select * from department order by id desc ");
                                                    foreach ($at as $q) {
                                                    ?>  
