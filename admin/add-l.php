...
extract($_POST);
if(isset($_POST['sub'])){
    $qr=mysqli_query($con,"insert into lecture_hall(name) values('$name')");

if ($qr) {
$_SESSION['bmsg']='<span style="color:green;">'."Lecture Hall was added successfully....".'</span>';
} else {
    $_SESSION['bmsg']='<span style="color:red;">'."Error adding Lecture Hall".'</span>';
}
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Add Lecture Hall</a></li>
                                ...
                                <div class="basic-form">
                                   <form action="#" method="POST">
                                        ...
                                        <div class="form-group">
                                            <p class="text-muted m-b-15 f-s-12">Lecture Hall Name:</p>
