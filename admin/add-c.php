...
extract($_POST);
if(isset($_POST['sub'])){
    $qr=mysqli_query($con,"insert into course(name) values('$name')");

if ($qr) {
$_SESSION['bmsg']='<span style="color:green;">'."Course was added successfully....".'</span>';
} else {
    $_SESSION['bmsg']='<span style="color:red;">'."Error adding course".'</span>';
}
                                ...
                                <div class="basic-form">
                                   <form action="#" method="POST">
                                        ...
                                        <div class="form-group">
                                            <p class="text-muted m-b-15 f-s-12">Course title:</p>
