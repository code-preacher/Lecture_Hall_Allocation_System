...
$k=mysqli_query($con,"select name from department where id='".$xx['department_id']."'");
                                ...
                                <div class="basic-form">
                                   <form action="cpass.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-rounded" name="matno"  required="required" value="<?php echo $xx['matno'];  ?>" disabled="disabled" >
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-rounded" disabled="disabled" value= <?php echo strtoupper($xx['level']); ?> >
                                        </div>

                                          <div class="form-group">
                                            <p class="text-muted m-b-15 f-s-12">Department :</p>
                                            <input type="text" class="form-control input-rounded" disabled="disabled" value="<?=$kk['name'];?>">
                                        </div>
