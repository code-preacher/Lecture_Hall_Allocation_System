...
<html lang="zxx">
   <head>
      ...
      <meta name="keywords" content="LECTURE HALL" />
      <script>
            ...
            <div class="container-fluid">
               <div class="hedder-up row">
                  <div class="col-lg-3 col-md-3 logo-head">
                     <h1><a class="navbar-brand" href="index.html">LECTURE HALL SYSTEM</a></h1>
                  </div>
               </div>
            </div>
                     ...
                     <div class="slider-img one-img">
                        <div class="container">
                           <div class="slider-info ">
                              <h5>Welcome <br>to Lecture Hall System</h5>
                              <div class="bottom-info">
                                 <p>Making learning stress free</p>
                              </div>
