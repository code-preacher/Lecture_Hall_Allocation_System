                              ...
                              <input type="text" id="myInput" onkeyup="myFunction()" class="form-control"  placeholder="Search for Matric Number....."  required>
                                ...
                                <div class="table-responsive">
                                    <table id="myTable" class="table table-hover table-bordered ">
                                        ...
                                        <tbody>
<?php
$m=mysqli_query($con,"select department_id from lecturer where email='".$_SESSION['username']."' ");
$t=mysqli_fetch_assoc($m);

$at=mysqli_query($con,"select * from user where department_id='".$t['department_id']."' order by id desc ");
foreach ($at as $qty) {
