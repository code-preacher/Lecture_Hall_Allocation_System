...
<?php
include '../config.php';
$x=mysqli_query($con,"select * from admin where username='".$_SESSION['username']."'");
                                ...
                                <div class="basic-form">
                                   <form action="cpass.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-rounded" name="uname"  required="required" value=<?php echo $xx['username'];  ?>  >
                                        </div>
                                        <div class="form-group">
